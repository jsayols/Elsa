ELSA stands for Enhanced Language Service Algorithm. This is an experimental application in Python for post-editing machine translations by prompting an LLM through API calls.
